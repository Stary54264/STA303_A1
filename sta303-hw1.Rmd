...
knitr::kable(coef_summary, caption = "Comparison of the log-rate ratios and 95% confidence intervals for Negative Binomial model relating literacy and age at marriage to the number of children, with an offset for years married. The results indicate similar trends as the Poisson model, with literacy being significant, and age at marriage having mixed effects. The reference category for age at marriage is 18 to 20 years.", digits = 3, align = "c") %>%
  kableExtra::kable_styling(full_width = FALSE, position = "center") %>%
